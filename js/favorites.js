...
let favoriteMealsFav = JSON.parse(localStorage.getItem('favoriteMeals')) || [];
...
function addfavorite(mealName) {
    if (!favoriteMealsFav.includes(mealName)) {
        favoriteMealsFav.push(mealName);
        localStorage.setItem('favoriteMeals', JSON.stringify(favoriteMealsFav));
